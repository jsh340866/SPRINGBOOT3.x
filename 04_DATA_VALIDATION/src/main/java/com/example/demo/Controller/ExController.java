...
public class ExController {
     ...
     */
    @GetMapping("/ex01")
    public void ex01(/* TODO: @Valid 검증 대상 + BindingResult 받기 */@Valid ExUserDto dto, BindingResult bindingResult){
     ...
     */
    @GetMapping("/ex02")
    public void ex02(/* TODO: @Valid 대상 + BindingResult 받기 */@Valid ExUserDto dto, BindingResult bindingResult){
    ...
    public void ex03(/* TODO: @Valid 대상 + BindingResult + Model 받기 */
            @Valid ExUserDto dto, BindingResult bindingResult, Model model) {
    ...
    @PostMapping("/ex04")
    public void ex04(/* TODO: @Valid 대상 + BindingResult 받기 */@Valid ExUserDto dto, BindingResult bindingResult){
     ...
     */
    @GetMapping("/ex05")
    public void ex05(/* TODO: @Valid 대상 + BindingResult 받기 */@Valid ExUserDto dto, BindingResult bindingResult){
        ...
        log.info("EX05 email 오류 메시지 : " + bindingResult.getFieldError("email").getDefaultMessage());
    }
